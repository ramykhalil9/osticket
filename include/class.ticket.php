...
implements RestrictedAccess, Threadable {
   ...
   /*============== Static functions. Use Ticket::function(params); =============nolint*/
    ...
    static function agentActions($agent, $options=array()) {
	 ...
	 // LUIS MOD: postResponse function, to add staff email replies as Responses, not Notes
	// postResponse is a copy of postNote with some changes to make it post a staff response instead of a note.
	function postResponse($vars, &$errors, $poster, $alert=true) {
        global $cfg, $thisstaff;
